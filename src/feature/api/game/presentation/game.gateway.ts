        ...
        await mutex.runExclusive(async () => {
          ...
          if (winnerStr === '') {
            ...
            if (this.gameService.isGameOver(match)) {
              ...
              await this.achievementUseCase.handleGameAchievement(match.playerA.id, match.score.playerA > match.score.playerB, match.score.playerA, match.score.playerB);
              await this.achievementUseCase.handleGameAchievement(match.playerB.id, match.score.playerB > match.score.playerA, match.score.playerB, match.score.playerA);
              return;
            } else {
              isGameReset = true;
